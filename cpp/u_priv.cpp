...
int main() {
    ...
    std::string emp_id = jsonData["emp_id"];             
    std::string privilege = jsonData["privilege"]; 
    ...
    std::string updateQuery = "UPDATE employee SET privilege = '" + privilege + "' WHERE id = " + emp_id;
    ...
    responseJson["emp_id"] = emp_id;
    responseJson["privilege"] = privilege;
